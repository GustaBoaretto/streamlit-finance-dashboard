...
empresas = [
    ...
    {"setor": "Distribuição de Combustíveis", "tipo": "Estratégico", "empresa": "Ipiranga (controladora)", "ticker": "UGPA3.SA", "moeda": "BRL"},
    {"setor": "Distribuição de Combustíveis", "tipo": "Estratégico", "empresa": "Vibra Energia", "ticker": "VBBR3.SA", "moeda": "BRL"},
    {"setor": "Distribuição de Combustíveis", "tipo": "Demais", "empresa": "AirBP (controladora)", "ticker": "BP", "moeda": "USD"},
    {"setor": "Distribuição de Combustíveis", "tipo": "Demais", "empresa": "ALE (controladora)", "ticker": "GLEN.L", "moeda": "GBP"},
    ...
    {"setor": "E&P Petróleo e Gás", "tipo": "Demais", "empresa": "Eneva", "ticker": "ENEV3.SA", "moeda": "BRL"},
    {"setor": "E&P Petróleo e Gás", "tipo": "Demais", "empresa": "Shell (controladora)", "ticker": "SHEL", "moeda": "USD"},
    {"setor": "E&P Petróleo e Gás", "tipo": "Demais", "empresa": "PRIO", "ticker": "PRIO3.SA", "moeda": "BRL"},
    ...
    {"setor": "E&P Petróleo e Gás", "tipo": "Demais", "empresa": "Equinor", "ticker": "E1QN34.SA", "moeda": "BRL"},
    {"setor": "E&P Petróleo e Gás", "tipo": "Demais", "empresa": "Petrogal (controladora)", "ticker": "GALP.LS", "moeda": "EUR"},
    ...
    {"setor": "Petroquímica", "tipo": "Demais", "empresa": "Oxiteno (controladora)", "ticker": "IVL.BK", "moeda": "THB"},
    ...
    # ============================================
    {"setor": "Logística, Transporte", "tipo": "Demais", "empresa": "Rumo", "ticker": "RAIL3.SA", "moeda": "BRL"},
    {"setor": "Logística, Transporte", "tipo": "Demais", "empresa": "Hidrovias do Brasil", "ticker": "HBSA3.SA", "moeda": "BRL"},
    {"setor": "Logística, Transporte", "tipo": "Demais", "empresa": "Santos Brasil", "ticker": "STOSF", "moeda": "USD"},
    {"setor": "Logística, Transporte", "tipo": "Demais", "empresa": "Vopak", "ticker": "VPK.AS", "moeda": "EUR"},
    {"setor": "Logística, Transporte", "tipo": "Demais", "empresa": "TAG", "ticker": "EGIE3.SA", "moeda": "BRL"},
    {"setor": "Logística, Transporte", "tipo": "Demais", "empresa": "New Fortress Energy", "ticker": "NFE", "moeda": "USD"},
